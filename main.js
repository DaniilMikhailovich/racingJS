const score = document.querySelector('.score'),
	...
	function getQuantity(heightElement){
	...
	function startGame() {
		...
		for(let i = 0; i < getQuantity(100); i++){
